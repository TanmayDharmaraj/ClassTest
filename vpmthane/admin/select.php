...
var test="r"+department+year+semester+subject;

var param = "table_name="+session+"&department="+department_name+"&year="+year_name+"&semester="+semester_name+"&subject="+subject_name+"&test_table="+test;
